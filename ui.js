...
import { CATALOG_META, labelFor, refFor, iconFor } from './catalog.js';
...
export class UI {
    ...
    _setupColorPickers() {
        ...
        // ── Helper: construye un picker inline ────────────────────────
        const setupInlinePicker = (triggerBtnId, pickerId, previewId, hexId, onColorChange) => {
            ...
            const updateColor = () => {
                ...
                // Actualizar el fondo del slider de tono para que sea visual
            ...
            triggerBtn.addEventListener('click', (e) => {
                ...
                if (!isOpen) updateColor(); // inicializar preview al abrir
            });
        ...
        document.querySelectorAll('.obj-swatch[data-color]').forEach(btn => {
            btn.addEventListener('click', (e) => {
                e.stopPropagation();
                // Cerrar el picker si estaba abierto al elegir un swatch predefinido
